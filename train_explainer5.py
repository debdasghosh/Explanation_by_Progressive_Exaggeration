...
def main():
    ...
    l2_loss = nn.MSELoss()
    l1_loss = nn.L1Loss()
    generator_loss = L.GenLoss('hinge', False)
    ...
    discriminator_loss = L.DisLoss('hinge', True)
    #print(dis)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        for batch_idx, (data, target) in enumerate(train_loader, 0):
            ...
            fake_target_logits = dis(fake_target_img, y_target)   


            # ============= Loss =============
            D_loss_GAN = discriminator_loss(real_source_logits, fake_target_logits) 
            G_loss_GAN = generator_loss(fake_target_logits)
            ...
            writer.add_scalar('Generator Loss', g_loss, counter)
            writer.add_scalar('Discrinator Loss', d_loss, counter)
